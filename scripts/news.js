...
//let data;
//apiKey1=e2dadb7dec7c46fc9dece4ee15f77703
//apiKey2=0dce433255314c708487fa7cedc66e2f
...
const getDataNews = async function (country, page) {
  try {
    ...
    const res = await fetch(
      `https://newsapi.org/v2/top-headlines?country=${country}&category=${currentUser.category}&pagesize=${currentUser.pageSize}&page=${page}&apiKey=e2dadb7dec7c46fc9dece4ee15f77703`
    );
